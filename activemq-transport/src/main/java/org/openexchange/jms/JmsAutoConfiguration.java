...
public class JmsAutoConfiguration {
    ...
    public SmsService smsService(JmsTemplate jmsTemplate) {
        return new SmsService() {
            ...
            private final String queueName = Mapping.queues.get(Sms.class);
    ...
    public QuoteService quoteService(JmsTemplate jmsTemplate) {
        return new QuoteService() {
            private final String QUOTES_QUEUE = Mapping.queues.get(Quote.class);

            @Override
            @Transactional(rollbackFor = Throwable.class)
            public void write(List<? extends Quote> list) {
